    ...
    <div className="min-h-screen bg-[#FAF9F6] text-[#0F172A] font-body selection:bg-[#F97316]/20 relative overflow-x-hidden flex flex-col justify-between">
      ...
      <header className="relative z-10 py-8 px-8 border-b border-slate-200/40 bg-white/70 backdrop-blur-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <img src="/logo-site.png" alt="SalesClin" className="h-9 w-auto" />
      ...
      <footer className="py-8 bg-white border-t border-slate-100 relative overflow-hidden z-10 w-full">
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-4 text-left">
            {/* Column 1: Brand */}

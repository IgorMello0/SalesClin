// Form component using react-hook-form directly (no Radix dependency)
...
const FormLabel = ({ className, ref, ...props }: React.ComponentPropsWithoutRef<typeof Label> & { ref?: React.Ref<HTMLLabelElement> }) => {
  const { error, formItemId } = useFormField()
  return <Label ref={ref} className={cn(error && "text-destructive", className)} htmlFor={formItemId} {...props} />
}
FormLabel.displayName = "FormLabel"

const FormControl = ({ ref, ...props }: React.HTMLAttributes<HTMLDivElement> & { ref?: React.Ref<HTMLDivElement> }) => {

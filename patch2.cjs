...
// 5. Update justification rendering exactly
const oldJustification = `                    {isLowerValue && (
...
content = content.replace(oldJustification, newJustification);
